 ...
 * @LastEditTime: 2020-11-09 14:11:35
 * @Description: 基础表格组件
                  ...
                  header: ( ) => {
                    return ( this.schema.selection.isMultiple ?? true ) ? h(
                      'el-checkbox',
                      {
                        ref: 'allCheckbox',
                        props: {
                          indeterminate: this.selections.length > 0 && this.selections.length < this.list.length,
                          ...
                          change: ( isChecked = false ) => {
                            ...
                            if ( isChecked ) {
                              ...
                              if ( this.selectionMethod ) {
                                result = this.selections = this.list.filter( row => !this.selectionMethod( row ) )
                              } else {
