 ...
 * @LastEditTime: 2020-09-23 16:15:44
 * @Description: 表格组件
 * @FilePath: \SCM 2.0\src\components\common\Table\index.js
 */
...
export default {
  name: 'ScmTable',
  components: {
    ToolBar: () => import( '@/components/common/Table/component/ToolBar' ),
    ColumnComponent,
    OperationComponent: () => import( './component/Column/Operation' ),
    Pagination: () => import( '@/components/common/Table/component/Pagination' )
  },
  props: {
    /* 表格配置 */
    schema: {
